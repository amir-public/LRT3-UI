...
## React App Setup (Local Environment)
To get started follow this steps:

1. Install [Node](https://nodejs.org/download/release/v12.20.0/) version 14 or [yarn](https://yarnpkg.com/getting-started/install)
2. Download or clone the repository.
3. Open the project and install packages by running: ```npm i``` or ```npm install``` or ```yarn```.
4. Clone the ASLPingServer (https://github.com/PCS-GIS-PAPIDS-Control-Software/ASLPingServer).
5. Run the node index.js to create socket connection to the server.
...
## Docker Setup Without Integrated With CI/CD
...
3. Replace the `web-server` with the latest build.
4. Run the ```docker compose up -d``` to install the docker container.


## Docker Setup Integrated With CI/CD
Setup the docker by following these steps:
1. Install Docker Desktop in the client. 
2. Clone ASL_Web_withDocker repository: (https://github.com/PCS-GIS-PAPIDS-Control-Software/ASL_Web_withDocker).
